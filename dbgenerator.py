...
table_standard_bar_structure = {
    ...
    'bar_cum_volume':'int', 
    'feat_buyInitTotal':'float',
    'feat_sellInitTotal':'float',
    'feat_signVolSide':'float',
    'feat_accumulativeVolBuyInit':'float',
    'feat_accumulativeVolSellInit':'float',
    'feat_accumulativeDollarValue':'float',
