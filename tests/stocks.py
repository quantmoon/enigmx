...
'ICE', 'INFN', 'AMPE', 'PRO', 'FTI', 'ZNGA', 'COLL', 'AVGO', 'PRG', 'DRQ', 'CMG', 'ENZ', 'RACE', 'BRMK', 'LIVX', 'MCHP', 
...
'DVD', 'KGC', 'WTTR', 'NOVT', 'PTVE', 'CSGS', 'ENSG',  'JWN','FDBC', 'VXRT', 'PTC', 'FBRX', 'LEU', 'PETZ', 'REX', 'CERE',
 ...
 'VACQ', 'VNT', 'NKE', 'MSA', 'SELB', 'TYL', 'SGC', 'GOGO', 'HAS', 'EA', 'ECL', 'TR', 'SGOC', 'APTO', 'GLSI', 'SWI', 'CVNA',
...
'DXCM', 'MCHX', 'CSPR', 'TFX', 'ATEN', 'CCIV', 'TWTR', 'RMBS', 'SRG', 'LDOS','EMAN', 'YTRA', 'ACTG', 'AERI', 'ALB', 'ARC', 
'FOCS', 'ITRI', 'SWTX', 'ATNI', 'ABST', 'ON', 'HZN', 'SANW', 'SIGA', 'CONE', 'HLF', 'SIBN', 'AAPL', 'PSAC', 'APOG', 'INFI', 
'REV', 'UTMD', 'MKC', 'HQY', 'ODP', 'AWK', 'GPN', 'ARPO', 'AKBA', 'ZI', 'ANGI', 'ALGS', 'VICR', 'DLTR', 'UTZ', 'MPLN', 'ASM', 
'AMBC', 'TACO', 'ILMN', 'CDNA', 'PQG', 'RMNI', 'ANAB', 'AZPN', 'OPGN', 'LUNA', 'CYTK', 'PFIE', 'AMK', 'NVEE', 'GLOP', 'VBLT', 
'PANW', 'UPWK', 'PIRS', 'HBM', 'CMTL', 'AZEK', 'EMX', 'XTNT', 'APPS', 'PXLW', 'VTVT', 'CDK', 'TEAM', 'SILV', 'FI', 'CECE', 'KLAC',
