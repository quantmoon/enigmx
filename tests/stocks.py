stocks = [ 
 'VTOL',
  'HTA', 'CDE', 'BBBY', 'ARDX', 'MYE', 'IAC', 'TJX', 'PBI', 'ADMS', 'FORR', 'BGS', 'B', 'VRM', 'IMXI', 'KMB', 'VFC',
...
'ICE', 'INFN', 'AMPE', 'PRO', 'FTI', 'ZNGA', 'COLL', 'AVGO', 'PRG', 'DRQ', 'CMG', 'ENZ', 'RACE', 'BRMK',  'MCHP',
'HLIT', 'KDNY', 'KVHI', 'BB', 'NVGS', 'SQ', 'CRIS', 'STFC', 'EHC', 'CIDM', 'CIR', 'ALC', 'RNA', 'MNKD', 'ACCO', 'FOSL',
'DVD', 'KGC', 'WTTR', 'NOVT', 'PTVE', 'CSGS', 'ENSG',  'JWN','FDBC', 'VXRT', 'PTC', 'FBRX', 'LEU', 'PETZ', 'REX', 'CERE',
 'ALDX', 'MTCH', 'EYE', 'STRL', 'GLOB', 'PARR', 'WIX', 'PAE', 'LESL', 'IIIV', 'GDDY', 'XPER', 'SCPL', 'WMG', 'XELA', 'AG',
  'VNT', 'NKE', 'MSA', 'SELB', 'TYL', 'SGC', 'GOGO', 'HAS', 'EA', 'ECL', 'TR', 'SGOC', 'APTO', 'GLSI', 'SWI', 'CVNA',
 'MYOV', 'FMC', 'MPX', 'SYBX', 'FIVE', 'TCMD', 'OIS', 'MCFT', 'RLMD', 'SEAC', 'ORN', 'IFMK', 'ODC', 'ROAD', 'UI', 'HRL', 'MMI',
...
'CDNS', 'HUN', 'FBC', 'APEI', 'DCO', 'AEZS', 'EEFT','FND', 'LPRO', 'EXEL', 'CIEN', 'PAAS',  'OSG', 'LHCG', 'NUS',
'RMR', 'YNDX', 'PLNT',  'GWRS', 'EXTN', 'REYN', 'FIZZ', 'SENS', 'LAUR', 'HCSG', 'VZ', 'SVM', 'SPPI', 'KZR', 'IMTX', 
...
'DXCM', 'MCHX', 'CSPR', 'TFX', 'ATEN', 'TWTR', 'RMBS', 'SRG', 'LDOS','EMAN', 'YTRA', 'ACTG', 'AERI', 'ALB', 'ARC',
'FOCS', 'ITRI', 'SWTX', 'ATNI', 'ABST', 'ON', 'HZN', 'SANW', 'SIGA', 'CONE', 'HLF', 'SIBN', 'AAPL', 'APOG', 'INFI',
'REV', 'UTMD', 'MKC', 'HQY', 'ODP', 'AWK', 'GPN', 'AKBA', 'ZI', 'ANGI', 'ALGS', 'VICR', 'DLTR', 'UTZ', 'MPLN', 'ASM',
'AMBC', 'TACO', 'ILMN', 'CDNA', 'RMNI', 'ANAB', 'AZPN', 'OPGN', 'LUNA', 'CYTK', 'PFIE', 'AMK', 'NVEE', 'GLOP', 'VBLT',
'PANW', 'UPWK', 'PIRS', 'HBM', 'CMTL', 'AZEK', 'EMX', 'XTNT', 'APPS', 'PXLW', 'VTVT', 'CDK', 'TEAM', 'SILV',  'CECE', 'KLAC',
 'KAR', 'KMX', 'REED', 'OSTK', 'EXPO', 'MORN', 'LSPD', 'KALV', 'STRM', 'MSGS', 'KIRK', 'MARA', 'CMPR', 'TRUE', 'RPAY', 
 'LZB','FBIO', 'SMMT', 'CSCW', 'CCF', 'MRK'
]

#'PROS','LIVX', 'VACQ','SPKE','STMP','CCIV','PSAQ','ARPO','PQG','FI','TBIO'
