    ...
    dfalphas = pd.DataFrame(
        {
            ...
            'alpha19':alpha19,'alpha20':alpha20,
            ...
            'alpha32':alpha32,'alpha33':alpha33,
            'alpha34':alpha34,'alpha35':alpha35,
            'alpha36':alpha36,'alpha37':alpha37,
            'alpha38':alpha38,'alpha39':alpha39,
            ...
            'alpha51':alpha51,'alpha52':alpha52,
            'alpha53':alpha53,'alpha54':alpha54,
            'alpha55':alpha55,'alpha57':alpha57,
            'alpha60':alpha60,'alpha61_integer':alpha61,
            'alpha62_integer':alpha62,'alpha64_integer':alpha64,
            'alpha65_integer':alpha65,'alpha66':alpha66,
            'alpha71':alpha71,'alpha72':alpha72,
            'alpha73':alpha73,'alpha77':alpha77, 
            'alpha88':alpha88, 'alpha92':alpha92,
            'alpha94':alpha94,
            #'alpha95':alpha95, # get the same number
            'alpha96':alpha96,'alpha98':alpha98,
            'alpha99_integer':alpha99,'alpha101':alpha101
            }
        )
